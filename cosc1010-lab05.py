...
for index in range(len(max_temps)):
    if max_temps[index]>Maximum:
        Maximum = max_temps[index]

for index in range(len(min_temps)):
    if min_temps[index]<Minimum:
        Minimum = min_temps[index]
        

print(f"The maximum temperature in Larmie for the year was {Maximum} degrees fairenheit")

print(f"The minimum temperature in Larmie for the year was {Minimum} degrees fairenheit")
...
for number in numbers:
    if numbers[x]==0:
        ...
        positive_num_sum=positive_num_sum+1
    elif numbers[x]<0:
        negative_num_sum=negative_num_sum+1
    x=x+1


print(f"Sum of positive numbers is {positive_num_sum}")
print(f"Sum of negative numbers {negative_num_sum}")
...
for number in numbers:
    if numbers[x]>0:
        positive_num_sum=positive_num_sum+number
    elif numbers[x]<0:
        negative_num_sum=negative_num_sum+number
    x=x+1

print(f"The total sum of the positive numbers is {positive_num_sum}")
print(f"The total sum of the negative numbers is {negative_num_sum}")
